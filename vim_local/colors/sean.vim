...
hi Error			ctermfg=red  ctermbg=yellow guifg=Red	guibg=Black
...
hi DiffAdd			cterm=bold ctermfg=10 ctermfg=17 gui=none guifg=bg guibg=Red
hi DiffDelete		cterm=bold ctermfg=10 ctermfg=17 gui=none guifg=bg guibg=Red
hi DiffChange			cterm=bold ctermfg=10 ctermfg=17 gui=none guifg=bg guibg=Red
hi DiffText			cterm=bold ctermfg=10 ctermfg=17 gui=none guifg=bg guibg=Red
